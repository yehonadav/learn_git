...
ask the repo's owner to add your username as a contributor  
after you've been approved, clone the repo  
create an issue in the github repo with your name  

create a local git branch with your username  
...
in your github issue, add a comment saying your branch is ready for review  
find another open issue with the same type of comment, and assign yourself for that issue  
  
fetch and checkout to the issue's branch and set your correct upstream branch  
...
in the github issue, add a comment saying the review and test acceptance has been successful, and close the issue  
